...
class HospitalPatient(models.Model):
    ...
    emergency_relationship = fields.Selection([('parent', 'Parent'), ('spouse', 'Spouse'), ('child', 'Child'), ('sibling', 'Sibling'), ('friend', 'Friend'), ('other', 'Other')], string="Relationship with Patient")
    ...
    payment_method = fields.Selection([('cash', 'Cash'), ('insurance', 'Insurance'), ('card', 'Card')], string="Preferred Payment Method")
